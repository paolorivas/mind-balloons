...
function Bubbles (_source, _parent, _onselect, _tiptext)
{
    ...
    this.createNewCircle = function (inName, inCount) 
    {
        this.datums["ZZ"] = {
            key : 'ZZ',
            count: inCount,
    ...
    this.growCircle = function (key) 
    {
        this.datums[key].count += 1000;
        this.prepare();
    }

    this.deleteCircle = function (key) 
    {
        delete this.datums[key];
        delete this.bubbles["_" + key];
        this.lines = [];
        this.prepare();
    }

    this.openModal = function () {
        this.concentrationOn = !this.concentrationOn;
        this.timer = 60;
        console.log(this.concentrationOn);
    }
